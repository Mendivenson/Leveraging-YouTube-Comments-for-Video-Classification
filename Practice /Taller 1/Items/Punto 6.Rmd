...
```{r, fig.width = 15, fig.align = 'center', fig.height=8, fig.cap = 'Graph from adjacency matrix vs graph from edge list matrix'}
...
plot.igraph(G1, edge.arrow.size = 0.1,
            ...
            edge.width = 1.5)
title(main = "Adjacency matrix", cex.main = 1.8, font = 2)
set.seed(1305)
plot.igraph(G, edge.arrow.size = 0.1,
            ...
            vertex.label.cex = 1.5,
            edge.width = 1.5)
title(main = "Edge list matrix", cex.main = 1.8, font = 2)
```
